...
#pragma endregion
	public: void DoWork(int tNN, double* tXT, double* tYT, double** tZT)
	{
		...
		for (I2 = 1; I2 <= tNN - 1; I2++) // Внешний цикл по строкам массива значений функции tZT
		{
		for (J2 = 1; J2 <= tNN - 1; J2++) // Внутренний цикл по элементам строк массива значений функции tZT
		{
